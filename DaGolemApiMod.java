package net.mcreator.dagolemapi;
...
@Mod("da_golem_api")
public class DaGolemApiMod {
	public static final Logger LOGGER = LogManager.getLogger(DaGolemApiMod.class);
	public static final String MODID = "da_golem_api";

	public DaGolemApiMod(IEventBus modEventBus) {
